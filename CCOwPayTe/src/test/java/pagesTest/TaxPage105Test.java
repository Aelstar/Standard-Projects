...
public class TaxPage105Test extends BaseTest{

	public TaxPage105Test() throws IOException {
		super();
	...
	public void get_TaxNames() throws InterruptedException {
		...
		WebElement IncomeLink108=driver.findElement(By.xpath("//li[@id='IncomeLink']/ul[@class='dropdown-menu']/li[1]/ul[@class='dropdown-menu']//a[@href='/etataxgateEF/IncomeTaxDeclarations/IncomeTax_105']"));
		IncomeLink108.click();
		...
		WebElement continbutton=driver.findElement(By.xpath("//button[@id='ToDeclaration105']"));
		continbutton.click();
