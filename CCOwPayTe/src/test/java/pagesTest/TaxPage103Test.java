...
public class TaxPage103Test extends BaseTest{

	public TaxPage103Test() throws IOException {
		super();
	...
	@Test
	public void get_TaxNames() throws InterruptedException {
...
//		driver.navigate().to("http://197.168.1.248/ETA/");	
		...
		WebElement IncomeLink108=driver.findElement(By.xpath("//li[@id='IncomeLink']/ul[@class='dropdown-menu']/li[1]/ul[@class='dropdown-menu']//a[@href='/etataxgateEF/IncomeTaxDeclarations/IncomeTax_103']"));
		IncomeLink108.click();
		...
		WebElement continbutton=driver.findElement(By.xpath("//button[@id='ToDeclaration103']"));
		continbutton.click();
...
System.err.println("Report 103 finished");
}
